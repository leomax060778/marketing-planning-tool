create column table "PLANNING_TOOL"."OUTCOMES"
(
        ...
        FOREIGN KEY ("OUTCOMES_TYPE_HIERARCHY_LEVEL_ID") REFERENCES "PLANNING_TOOL"."OUTCOMES_TYPE_HIERARCHY_LEVEL"("OUTCOMES_TYPE_HIERARCHY_LEVEL_ID")
);