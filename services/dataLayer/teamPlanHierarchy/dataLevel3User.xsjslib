...
function deleteLevel3User(objLevel3, userId){
	var parameters = {};
	parameters.in_hl3_id = objLevel3.IN_HL3_ID;
	parameters.in_user_id = objLevel3.IN_HL3_USER_ID;
	return db.executeScalarManual(DEL_HL3_USER,parameters,"out_result");
}